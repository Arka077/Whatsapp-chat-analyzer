...
def show(df):
    ...
    if st.session_state.qa_history:
        ...
        # Professional answer box with CSS override for Dark Mode
        answer_box = f"""
        <div class="rag-answer-box" style="
        ...
        ">
            <style>
                /* Forces all text, including paragraphs generated by Markdown, to be dark */
                .rag-answer-box, .rag-answer-box p, .rag-answer-box li {{
